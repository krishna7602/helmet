...
function SignUp() {
  ...
  return (
    <div className='d-flex justify-content-center align-items-center bg-primary vh-100'>
        <div div className='p-3 rounded w-25'>
          <form action="" onSubmit={handleSubmit}>
            <div className='mb-3'>
              <label htmlFor="fname"><strong>First Name</strong></label>
              <input type="text" onSubmit={handleInput} placeholder='First Name' className='form-control rounded-0'/>
              {errors.fname && <span className='text-danger'>{errors.fname}</span>}
            </div>
            
            <div className='mb-3'>
              <label htmlFor="lname"><strong>Last Name</strong></label>
              <input type="text" onSubmit={handleInput} placeholder='Last Name' className='form-control rounded-0'/>
             {errors.lname && <span className='text-danger'>{errors.lname}</span>}
            </div>
          
            <div className='mb-3'>
              <label htmlFor="email"><strong>Email</strong></label>
              <input type="email" onSubmit={handleInput} placeholder='Enter Email' className='form-control rounded-0'/>
            {errors.email && <span className='text-danger'>{errors.email}</span>}
          </div>
          
          <div className='mb-3'>
              <label htmlFor="password"><strong>Password</strong></label>
              <input type="password" onSubmit={handleInput} placeholder='Enter Password' className='form-control rounded-0'/>
